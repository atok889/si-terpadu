 ...
 */
public class JumlahRekruitmenPegawaiWnd extends ClassApplicationModule {
    ...
    public void viewReport() throws Exception {
        try {
            JumlahRekruitmenPegawaiDAO dao = new JumlahRekruitmenPegawaiDAOImpl();
            CategoryDataset dataset = null;
            UnitKerja selectedUnit = (UnitKerja) cmbCakupan.getSelectedItem().getValue();
            dataset = dao.getJumlahRekruitmen(selectedUnit);
            ChartFactory.setChartTheme(StandardChartTheme.createLegacyTheme());
            BarRenderer.setDefaultBarPainter(new StandardBarPainter());
            chart = ChartFactory.createBarChart(
                    "Jumlah Rekruitmen Pegawai Tetap", // chart title
